...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [👿](https://telegra.ph/file/12177617d50bed6e5e36f.jpg) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *Vegeta Kenpachi*
`𝙸'𝚖 𝚑𝚎𝚛𝚎 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙𝚜! 𝙷𝚒𝚝` *📚𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐏𝐥𝐚𝐜𝐞😇", url="t.me/vegeta_kenpachibot?startgroup=true"),
    ],
     [
        InlineKeyboardButton(text="𝐀𝐛𝐨𝐮𝐭💝", callback_data="evil_"),
        InlineKeyboardButton(
            text="dev🌐", url=f"http://t.me/charmyanime"
        ),
     ],
     [  
        InlineKeyboardButton(text="sup anime grp🛠", url="https://t.me/anime_period"),
        InlineKeyboardButton(text="team", url="https://t.me/shiro_bot_support"),
    ], 
...
HELP_STRINGS = """
`𝙷𝚎𝚢!.. 𝙸'𝚖` 👿 *vegeta kenpachi* [👿](https://telegra.ph/file/12177617d50bed6e5e36f.jpg)
`𝙲𝚕𝚒𝚌𝚔 𝚘𝚗 𝚝𝚑𝚎 𝚋𝚞𝚝𝚝𝚘𝚗𝚜 𝚋𝚎𝚕𝚘𝚠 𝚝𝚘 𝚐𝚎𝚝 𝚍𝚘𝚌𝚞𝚖𝚎𝚗𝚝𝚊𝚝𝚒𝚘𝚗 𝚊𝚋𝚘𝚞𝚝 𝚜𝚙𝚎𝚌𝚒𝚏𝚒𝚌 𝚖𝚘𝚍𝚞𝚕𝚎𝚜..`"""
evil_IMG = "https://telegra.ph/file/12177617d50bed6e5e36f.jpg"
        ...
        query.message.edit_text(
            text=""" ℹ️ I'm powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_My licensed under the GNU General Public License v3.0_ 
                      here is this [owner](https://t.me/charmyanime) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hey!.. I'm *vegeta kenpachi*
                 \nHere is the [team](https://t.me/shiro_bot_support) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
